...
var propertyDictionary = [
    ...
    {tag : "example", property : "highlight", options: ["c", "cpp", "cs", "lua", "basic", "vb", "xml", "html", "sql", "bash", "python", "js", "cshtml", "objc", "go", "java"]},
    {tag : "tab", property : "highlight", options: ["c", "cpp", "cs", "lua", "basic", "vb", "xml", "html", "sql", "bash", "python", "js", "cshtml", "objc", "go", "java"]},
