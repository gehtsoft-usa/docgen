...
<table class="decl">
 <tr><td colspan="2">Python</td></tr>
 <tr><td width="1%" nowrap="" valign="top"></td>
     <td width="99%" valign="top"><code><xsl:value-of select="ext:get('prefix')" /> <b><xsl:value-of select="ext:get('name')" /></b>(<xsl:value-of select="ext:get('params')" disable-output-escaping="yes" />) <xsl:if test="string-length(./@return) > 0">-> <xsl:value-of select="ext:get('return')" disable-output-escaping="yes" /></xsl:if></code></td></tr>
</table>
    </xsl:template>
</xsl:stylesheet>
