...
<table class="decl">
 <tr><td colspan="2">EasyLanguage</td></tr>
 <tr><td width="1%" nowrap="" valign="top"><code>DefineDLLFunc:</code></td>
     <td width="99%" valign="top"><code>"<xsl:value-of select="ext:get('prefix')" />", <xsl:value-of select="ext:get('return')" />, <b>"<xsl:value-of select="ext:get('name')" />"</b><xsl:if test="string-length(ext:get('params')) > 0">, <xsl:value-of select="ext:get('params')" /></xsl:if>;</code></td></tr>
</table>
    </xsl:template>
</xsl:stylesheet>
